    ...
    <body>
        ...
        <main>
            <section>
                ...
                <div class="row">
                    <form class="col s12 m6 l6 offset-l3 offset-m3" action="validaloginaluno.php" method="POST">
                        <div class="row">
                ...
                <div class="row"> 
                    <form class="col s12 m6 l6 offset-l3 offset-m3">   
                        ...
                        <a href="cadastroaluno.php" class="waves-effect waves-light btn col s12 m6 l6 offset-l3 offset-m3">Cadastrar</a>
                    </form>
                </div>
            </section>
        </main>
