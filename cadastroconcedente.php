...
?>
        <main>
            <section>
                ...
                <div class="row">
                    <form class="col s12 m6 l6 offset-l3 offset-m3" action="cadastraconcedente1.php" method="POST">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                            <input placeholder="Insira seu cpf" id="cpf" name="cpf" type="number" sizeof="11" class="validate" required>
                            <label for="first_name">CPF</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12">
                            <input placeholder="Insira sua empresa" id="empresa" name="empresa" type="text" class="validate" required>
